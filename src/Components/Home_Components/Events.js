...
const EventsComponent=({image,address,date,title,content})=>{
    return(
        <>
...
const Events = () => {
    ...
    return (
        ...
        <div className="d-flex text-light justify-content-xl-between ovx">
            <EventsComponent image="https://source.unsplash.com/1600x900/?wine" address="Blk 341, Le Bon Funk, 29 Club Street Singaore 069414" date="4 March 2021 , Tuesday , 4:30 PM" title="Lorem ipsum dolor sit amet consectetur adipisicing elit." content="Lorem ipsum dolor sit amet consectetur adipisicing elit. Odio iusto incidunt necessitatibus quam cum, deserunt reprehenderit esse voluptas!"/>
            <div className="col-4 my-3" style={{marginRight:"40px",height:"auto",width:"420px"}}>
