    ...
    return (
        <section className="plr py-5">
                ...
                <div className="row">
                    ...
                    <div className="col-lg-7 text-md-start text-center fwl d-flex flex-column justify-content-evenly">
                        ...
                        <div className="d-flex justify-content-md-between flex-md-row flex-column">
                            <button type="button" className="btn btn-danger my-2 " style={{width:"350px",borderRadius:"25px"}}>Stater Tier Subscription <i className="fas fa-arrow-right"></i></button>
                            <button type="button" className="btn btn-danger my-2 " style={{width:"350px",borderRadius:"25px"}}>Advance Tier Subscription <i className="fas fa-arrow-right"></i></button>
                        </div>
                    </div>
                </div>
            </section>
