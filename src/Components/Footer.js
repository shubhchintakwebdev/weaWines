...
const Footer = () => {
    return (
        ...
        <footer className="bg-dark text-light text-start">
            <div className="row plr py-5">
                <div className="col-md-3">
                    ...
                    <p><i className="fas fa-map-marker-alt fs-3"></i> Blk 341, Le Bon Funk, 29 Club Street Singaore
                        069414</p>
                    <p><i className="fas fa-phone-alt fs-3"></i> +65 7865 7679</p>
                    <p><i className="fas fa-envelope fs-3"></i> info@weawines.com.sg</p>
                </div>
                <div className="col-md-3">
                ...
                <div className="col-md-3">
                    <h4 className="mb-4">Our Mailing List</h4>
        ...
        <div className="row text-light plr pt-3" style={{backgroundColor:"black"}}>
            <div className="col-md-6">
              <p><i className="far fa-copyright"></i> 2021 , Wea Wines. All Rights Reserved.</p>
            </div>
