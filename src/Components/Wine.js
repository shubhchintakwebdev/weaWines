...
class Wine extends Component {
  ...
  componentDidMount() {
    ...
    axios.get("https://weawines.shubhchintak.co/wp-json/wp/v2/wineries?per_page=100&filter[orderby]=date&order=asc")
    .then(res => {
    ...
    return (
      <div >
        ...
        <div className="mobileview" >
          <select className="select" type="text" name="selected_option"  value={this.state.selected_option} onChange={this.handleChange}> 
